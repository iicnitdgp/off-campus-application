  ...
  const handleCredentialsLogin = async (e) => {
    ...
    if (res?.error) {
      if (res.error === 'UserNotFound') {
        toast.error('User not found! Please contact admin for access.', {
          position: "top-right",
          autoClose: 5000,
        })
      } else {
        ...
        <div className={styles.loginCard}>
          <div className={styles.header}>
            <div className={styles.logo}>
              <div className={styles.logoIcon}>IIC</div>
              <div className={styles.logoText}>
                <div className={styles.logoTitle}>Admin Portal</div>
                <div className={styles.logoSubtitle}>NIT Durgapur</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.formSection}>
            ...
            <p className={styles.subtitle}>Access the placement management portal</p>
